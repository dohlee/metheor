...
fn process_read(r: bam::Record) -> bam::Record {
    r
}

pub fn compute(input: &str, output: &str, min_depth: i32) {
    println!("Running compute_me with parameters input={}, output={}, min_depth={}", input, output, min_depth);
